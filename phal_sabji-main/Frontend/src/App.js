...
const App = () => {
  ...
  const handleCustomerData = (customerId,first_name) => {
  ...
  return (
    <div className="app">
      <Router>
        <Header cartItems={cartItems} isSuccess={isSuccess} first_name={first_name}/>
        <Routes
          productItems={productItems}
          cartItems={cartItems}
          handleAddProduct={handleAddProduct}
          handleRemoveProduct={handleRemoveProduct}
          handleCartClearance={handleCartClearance}
          handleCustomerData={handleCustomerData} // Pass the handleCustomerData function
